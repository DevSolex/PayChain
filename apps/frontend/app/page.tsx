...
const chains = [
  { name: 'Stellar', status: 'Live', color: 'text-blue-400' },
  { name: 'Base', status: 'Coming Soon', color: 'text-gray-400' },
  { name: 'Celo', status: 'Coming Soon', color: 'text-gray-400' },
]

const testimonials = [
  { name: 'Sarah K.', role: 'CTO, RemoteFirst', text: 'PayChain cut our payroll processing time from 3 days to 30 seconds.' },
  { name: 'David M.', role: 'Founder, DAO Labs', text: 'Finally a payroll tool built for Web3 teams. Our contributors love it.' },
  { name: 'Amara O.', role: 'HR Lead, TechAfrica', text: 'No more currency conversion headaches. We pay in USDC and everyone is happy.' },
]
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b px-6 py-4 flex items-center justify-between max-w-6xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg">PayChain</span>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Pay your remote team in USDC, USDT, or XLM. Instant, borderless, and fully transparent on the Stellar blockchain.
        </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-center mb-12">Why PayChain?</h2>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-muted-foreground mb-10">Built on Stellar, expanding to more chains soon.</p>
      ...
      <section className="max-w-2xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-muted-foreground mb-8">Join hundreds of companies paying their teams in crypto.</p>
        <Link href="/register">
          <Button size="lg" className="gap-2">
      ...
      <footer className="border-t px-6 py-8 text-center text-sm text-muted-foreground">
        <p>© 2026 PayChain. Built on Stellar. MIT License.</p>
      </footer>
    </div>
  )
}
